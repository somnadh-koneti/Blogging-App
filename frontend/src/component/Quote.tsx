...
return (
    ...
    <div className=" w-1/2 ">    
        ...
        Join our vibrant community of writers and creators! Signing up is
        quick and easy. Simply, signup to get started on your journey of sharing your thoughts, ideas, and stories with the world.
        </div>
        <div className="text-xl pb-2 font-bold tracking-wide leading-relaxed text-justify">Why Join Us?</div>

        <div className="text-xl pb-2 tracking-wide leading-relaxed text-justify">
